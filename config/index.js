export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe1c477d477908a36",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "3087a9a15688e9b833b779e4f6aee3aa",
  ...
  USERS: [
    {
      ...
      id: "oTnFg6W4uGTISRyxi53BxR3fpnfc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "diF1EsqZDMDrvTxMkxU1_oN7xurfWUn5hFowjAcPTqg",
      // 所在省份
      province: "湖南",
      // 所在城市
      city: "长沙",
